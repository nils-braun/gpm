...
# TODO: Later it should ne be allowed to set the externals etc. from python, but only via config file
def gpm(base_dir=".", result_dir="results", externals=None):
    ...
    return GPM(base_dir, result_dir, externals)
